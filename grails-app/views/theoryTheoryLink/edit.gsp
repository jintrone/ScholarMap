...
<html>
	...
	<body>
		<a href="#edit-theoryTheoryLink" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-theoryTheoryLink" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${theoryTheoryLinkInstance?.version}" />
				<fieldset class="form">
