...
<div class="fieldcontain ${hasErrors(bean: theoryTheoryLinkInstance, field: 'fromTheory', 'error')} required">
	...
	<g:select id="fromTheory" name="fromTheory.id" from="${cssttheorybuilder.Theory.list()}" optionKey="id" required="" value="${theoryTheoryLinkInstance?.fromTheory?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: theoryTheoryLinkInstance, field: 'toTheory', 'error')} required">
	...
	<g:select id="toTheory" name="toTheory.id" from="${cssttheorybuilder.Theory.list()}" optionKey="id" required="" value="${theoryTheoryLinkInstance?.toTheory?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: theoryTheoryLinkInstance, field: 'user', 'error')} required">
	...
	<g:select id="user" name="user.id" from="${cssttheorybuilder.User.list()}" optionKey="id" required="" value="${theoryTheoryLinkInstance?.user?.id}" class="many-to-one"/>
</div>
