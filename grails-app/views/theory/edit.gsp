...
<body>
<a href="#edit-theory" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-theory" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${theoryInstance?.version}"/>
        <fieldset class="form">
