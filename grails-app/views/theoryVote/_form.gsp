...
<div class="fieldcontain ${hasErrors(bean: theoryVoteInstance, field: 'theory', 'error')} required">
    ...
    <g:select id="theory" name="theory.id" from="${cssttheorybuilder.Theory.list()}" optionKey="id" required=""
...
<div class="fieldcontain ${hasErrors(bean: theoryVoteInstance, field: 'user', 'error')} required">
    ...
    <g:select id="user" name="user.id" from="${cssttheorybuilder.User.list()}" optionKey="id" required=""
