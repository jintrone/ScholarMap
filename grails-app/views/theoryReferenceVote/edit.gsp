...
<body>
<a href="#edit-theoryReferenceVote" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-theoryReferenceVote" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${theoryReferenceVoteInstance?.version}"/>
        <fieldset class="form">
